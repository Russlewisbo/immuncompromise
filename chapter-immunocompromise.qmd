...
![Timeline of infection risk after allogeneic hematopoietic stem cell transplantation. The phases of immune reconstitution and corresponding infection susceptibilities are shown. Bacterial infections predominate in the early neutropenic phase, viral infections (particularly CMV and other herpesviruses) peak in the early post-engraftment phase, and late opportunistic infections reflect persistent immune defects and GVHD-related immunosuppression.](images/allo_hcst.png){#fig-hsct-timeline fig-align="center"}

![Timeline of immunosuppression and infectious complications associated with CAR-T cell therapy. The lymphodepletion conditioning regimen, cytokine release syndrome (CRS), immune effector cell-associated neurotoxicity syndrome (ICANS), and prolonged B-cell aplasia each create distinct windows of infection vulnerability [@maus2020].](images/car-t.png){#fig-cart-timeline fig-align="center"}
...
![Mechanism of ibrutinib-associated invasive aspergillosis. BTK inhibition impairs not only B-cell signaling but also neutrophil and macrophage antifungal effector functions, particularly when combined with concurrent glucocorticoid therapy.](images/ibrutinib.png){#fig-ibrutinib fig-align="center"}

![Central nervous system aspergillosis complicating ibrutinib therapy. CNS involvement is an increasingly recognized manifestation of disseminated aspergillosis in patients receiving BTK inhibitors, particularly when combined with corticosteroids.](images/cns_aspergillosis.png){#fig-cns-asp fig-align="center"}
