...
<center>**A concept by Dr. Robert Rubin** (MGH Boston):</center>
...
## Allogeneic hematopoetic stem cell transplantation (HSCT) recipients

![](images/allo_hcst.png){fig-align="center" width="800"}
...
## Immunosuppresion timeline with CAR-T
...
![](images/ibrutinib.png){fig-align="center"}

## Unexpected fungal infections

![](images/cns_aspergillosis.png){fig-align="center"}
...
-   Coagulase-negative staphylococci more common than <br> *Staphylococcus aureus* (central venous catheter)
...
**Antiviral prophylaxis:** Val(acyclovir) for CMV (weak), HSV, VZV prevention. Valganciclovir or letermovir for higher risk CMV patients
